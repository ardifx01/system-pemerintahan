...
import { Calendar, User, Clock, Share2, Printer, BookOpen, ChevronLeft, Eye, Facebook, Twitter, Bookmark, ThumbsUp } from 'lucide-react';
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 text-white bg-black/50">
                                ...
                                <p className="text-sm opacity-80">{berita.penulis} • {formatDate(berita.tanggal_publikasi)}</p>
                            </div>
                        </motion.div>
                    </motion.div>
                )}
